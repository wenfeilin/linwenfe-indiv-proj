...
function useSpotifySDKInit() {
  const playerRef = useRef<Spotify.Player | null>(null); // survives rerenders and so will only have one instance of an actual music player
...
export default useSpotifySDKInit;
